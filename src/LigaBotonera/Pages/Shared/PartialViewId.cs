namespace LigaBotonera.Pages.Shared;

public static class PartialViewId
{
    ...
    public const string Clubs_Form = "Clubs/_Form";
    public const string Clubs_Grid = "Clubs/_Grid";
}